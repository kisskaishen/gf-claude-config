<template>
  <div class="h-full">
    <div class="p-6 mx-auto">
      <!-- 标题区域 -->
      <div class="mb-8">
        <h1 class="mb-2 text-3xl font-bold text-gray-800">消息通知订阅配置</h1>
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center">
            <div class="flex items-center" v-if="balanceReminder">
              <el-button
                type="primary"
                plain
    ...
    <!-- 余额不足提醒dialog -->
    <NotificationDialog
      ref="balanceReminderDialogRef"
      v-model:visible="balanceReminder"
    />
  </div>
</template>
...
const balanceReminderDialogRef = ref(null);
const balanceReminder = ref(false);

const handleBalanceReminderChange = (val: boolean) => {
  if (val) {
    // 展示对应dialog
