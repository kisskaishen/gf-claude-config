<template>
  <div class="container p-6 mx-auto">
    ...
    <!-- 右侧帮助和反馈 -->
    <div
      class="hidden fixed right-0 bottom-1/4 flex-col gap-2 px-1.5 py-3 bg-white shadow-md -translate-y-1/2"
    >
      <!-- 帮助 -->
      <div
        class="flex flex-col justify-center items-center w-12 bg-white transition-shadow cursor-pointer"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
