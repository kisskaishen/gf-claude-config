export default {
  ...
  "web.gfuc.order_management": "Order",
  "web.gfuc.single_ticket_order": "Create Order",
  "web.gfuc.batch_order": "Bulk Upload",
  "web.gfuc.order_list": "All Orders",
  "web.gfuc.financial_management": "Finance",
  "web.gfuc.message_subscription": "Notifications",
  "web.gfuc.recharge": "Top Up",
  "web.gfuc.recharge_record": "Top Up Record",
  "web.gfuc.balance": "Balance",
  "web.gfuc.bill": "Billing",
  ...
  "web.gfuc.please_select_value_added_service":
    "Please select value-added service",
  ...
  "web.gfuc.upload_task_file_size_tip":
    "File size up to 100MB, max 5000 orders per upload",
  ...
  // 404
  "web.gfuc.page_not_found": "Page Not Found",
