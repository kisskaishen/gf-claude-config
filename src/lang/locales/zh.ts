export default {
  ...
  "web.gfuc.please_complete_step": "请先完善第{step}步的信息",
  ...
  "web.gfuc.weight_range": "包裹重量必须在0.001-50之间",
  ...
  "web.gfuc.days_delivery_in_progress": "近7天包裹派送中包裹数",
  "web.gfuc.days_signed_orders": "近7天签收包裹数",
  "web.gfuc.tracking_no": "请输入你的运单号",
  "web.gfuc.query": "查询",
  "web.gfuc.track_query": "轨迹查询",
