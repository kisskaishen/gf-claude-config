export default {
  ...
  "web.gfuc.message_subscription": "Messages et notifications",
  "web.gfuc.recharge": "Nouveaux crédits",
  "web.gfuc.recharge_record": "Historique des crédits",
  ...
  "web.gfuc.email_not_registered":
    "Cet e-mail n'est pas encore enregistré. Veuillez vérifier et réessayer.",
  ...
  "web.gfuc.collection_start_time": "Heure de début d'enlèvement",
  "web.gfuc.collection_end_time": "Heure de fin d'enlèvement",
  ...
  "web.gfuc.please_select_product_info":
    "Veuillez sélectionner les informations du produit logistique",
  "web.gfuc.please_select_value_added_service":
    "Veuillez sélectionner le service à valeur ajoutée",

  "web.gfuc.parcel_info": "Informations du colis & autres infos",
  "web.gfuc.total_parcel_weight": "Poids total du colis (kg)",
  "web.gfuc.parcel_length": "Longueur (cm)",
  "web.gfuc.parcel_width": "Largeur (cm)",
  "web.gfuc.parcel_height": "Hauteur (cm)",
  "web.gfuc.total_parcel_weight_placeholder":
    "Veuillez entrer le poids total du colis (kg)",
  "web.gfuc.parcel_length_placeholder":
    "Veuillez entrer la longueur du colis (cm)",
  "web.gfuc.parcel_width_placeholder":
  ...
  "web.gfuc.declared_value": "Valeur déclarée (EUR)",
  "web.gfuc.customer_order_no": "Numéro de commande client",
  "web.gfuc.reference_no": "Numéro de référence",
  "web.gfuc.service_provider_tracking_no": "Numéro de suivi du prestataire",
  "web.gfuc.enter_product_name_cn": "Veuillez entrer le nom du produit (CN)",
  "web.gfuc.enter_product_name_en": "Veuillez entrer le nom du produit (EN)",
  "web.gfuc.enter_product_quantity": "Veuillez entrer la quantité du produit",
  "web.gfuc.enter_total_declared_value":
    "Veuillez entrer la valeur déclarée totale",
  "web.gfuc.unique_customer_order_no": "Numéro de commande client unique",
  "web.gfuc.platform_reference_no": "Numéro de référence de la plateforme",
  "web.gfuc.enter_parcel_weight": "Veuillez entrer le poids du colis",
  "web.gfuc.enter_parcel_length": "Veuillez entrer la longueur du colis",
  "web.gfuc.enter_parcel_width": "Veuillez entrer la largeur du colis",
  "web.gfuc.enter_parcel_height": "Veuillez entrer la hauteur du colis",
  ...
  "web.gfuc.please_complete_step": "Veuillez d'abord compléter l'étape {step}",
  ...
  "web.gfuc.setting": "Paramètres",
  "web.gfuc.waybill_no": "Numéro de waybill",
  "web.gfuc.basic_info": "Informations de base",
  "web.gfuc.product_type": "Type de produit",
  "web.gfuc.shipment_info": "Informations de shipment",
  "web.gfuc.delivery_info": "Information de livraison",
  "web.gfuc.third_party_tracking": "Numéro de tracking tiers",
  "web.gfuc.product": "Produit",
  "web.gfuc.total_quantity": "Quantité totale",
  "web.gfuc.total_weight": "Poids total",
  "web.gfuc.parcel_volume": "Volume du colis",
  ...
  "web.gfuc.weight_range": "Poids du colis doit être entre 0.001-50",
  ...
  "web.gfuc.upload_task_file_size_tip":
    "Taille de fichier jusqu'à 100Mo, max 5000 commandes par fichier",
  ...
  "web.gfuc.days_delivery_in_progress":
    "Colis en livraison ces 7 derniers jours",
  "web.gfuc.days_signed_orders": "Colis signés ces 7 derniers jours",
  "web.gfuc.tracking_no": "Veuillez saisir votre numéro de suivi",
  "web.gfuc.query": "Rechercher",
  "web.gfuc.track_query": "Recherche de suivi",
  ...
  "web.gfuc.help_center": "Centre d'Aide",
  "web.gfuc.help_center_desc":
    "Trouvez les informations d'aide dont vous avez besoin",
  "web.gfuc.help_detail": "Détails de l'aide",
  "web.gfuc.help_search_placeholder": "Rechercher des questions...",
  "web.gfuc.help_search_no_results": "Aucun résultat trouvé",
  "web.gfuc.help_category_shipping": "Expédition et Transport",
  "web.gfuc.help_category_billing": "Questions de Facturation",
  "web.gfuc.help_category_account": "Lié au Compte",
  "web.gfuc.help_category_technical": "Problèmes Techniques",
  "web.gfuc.help_faq": "Questions Fréquentes",
  "web.gfuc.help_contact": "Nous Contacter",
  "web.gfuc.help_contact_desc":
    "Si ce qui précède n'a pas résolu votre problème, veuillez contacter notre service client",
  ...
  "web.gfuc.feedback_hint":
    "Vous pouvez signaler des problèmes ou suggestions. Vos retours nous aident à améliorer le système.",
  "web.gfuc.feedback_title": "Titre",
  "web.gfuc.feedback_title_placeholder": "Résumez brièvement votre problème",
  "web.gfuc.feedback_description": "Description",
  "web.gfuc.feedback_description_placeholder":
    "Veuillez décrire le problème en détail, y compris les étapes, résultats attendus et réels",
  "web.gfuc.feedback_upload": "Images (Optionnel)",
  "web.gfuc.feedback_upload_drag_hint": "Cliquez ou glissez les images ici",
  "web.gfuc.feedback_upload_hint":
    "Jusqu'à 6 images, JPG/PNG/GIF, max 10 Mo chacune",
  "web.gfuc.feedback_submit": "Soumettre",
  ...
  // 404
  "web.gfuc.page_not_found": "Page introuvable",
